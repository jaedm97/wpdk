...
(function($) {
  ...
  function WPDK_SettingsAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  WPDK_SettingsAjaxChosen.prototype.init = function() {
  ...
  WPDK_SettingsAjaxChosen.prototype.events = function() {
  ...
  WPDK_SettingsAjaxChosen.prototype.search_field_focused = function() {
  ...
  WPDK_SettingsAjaxChosen.prototype.search_welcome_message = function() {
  ...
  WPDK_SettingsAjaxChosen.prototype.update_list = function() {
  ...
  WPDK_SettingsAjaxChosen.prototype.show_results = function( items ) {
  ...
  $.fn.WPDK_SettingsAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new WPDK_SettingsAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, WPDK_SettingsAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  WPDK_SettingsAbstractChosenOrder = (function() {

    function WPDK_SettingsAbstractChosenOrder() {}

    WPDK_SettingsAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    WPDK_SettingsAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    WPDK_SettingsAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    WPDK_SettingsAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    WPDK_SettingsAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    WPDK_SettingsAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    WPDK_SettingsAbstractChosenOrder.WPDK_SettingsChosenOrder = function(select, order, force) {
    ...
    return WPDK_SettingsAbstractChosenOrder;
  ...
  $.fn.extend({
    WPDK_SettingsChosenOrder: function(order, force) {
      return _WPDK_SettingsChosenOrder.WPDK_SettingsChosenOrder(this, order, force);
    }
  });

  this._WPDK_SettingsChosenOrder = (function(_super) {
    __extends(_WPDK_SettingsChosenOrder, _super);

    function _WPDK_SettingsChosenOrder() {
      _ref = _WPDK_SettingsChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _WPDK_SettingsChosenOrder.relAttributeName = 'data-option-array-index';

    _WPDK_SettingsChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _WPDK_SettingsChosenOrder.getDOMElement = function(element) {
    ...
    _WPDK_SettingsChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _WPDK_SettingsChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _WPDK_SettingsChosenOrder;

  })(WPDK_SettingsAbstractChosenOrder);
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectWPDK_Settings = FormSerializer.serializeObject;
    $.fn.serializeJSONWPDK_Settings   = FormSerializer.serializeJSON;
  }
